...
{
	public static final String[] processNames = {"GasLeakageManagement", "ManualEmergencyManagement"};
...
//			}
	...
	public static ActivitiProcessInstance createProcessInstance(String name, Map<String, Object> parameters)
	{
		List<String> names = Arrays.asList(processNames);
		...
		RuntimeService runtime = getEngine().getRuntimeService();
		ProcessInstance i = runtime.startProcessInstanceByKey(name, parameters);
		//runtime.addUserIdentityLink(i.getProcessInstanceId(), "ettore", IdentityLinkType.STARTER);
